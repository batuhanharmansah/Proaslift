                ...
                <div class="space-y-2">
                    @foreach($recentProducts->take(4) as $product)
                        <div class="flex items-center justify-between text-sm">
                            <div class="text-blue-800">{{ $product->product_name ?? '-' }}</div>
    ...
    <div class="mt-8 bg-gradient-to-r from-green-500 to-green-600 rounded-2xl p-8 text-white">
        <div class="flex items-center justify-between">
            ...
            <div class="flex space-x-4">
                ...
                <a href="{{ route('employee.profile') }}" class="bg-white bg-opacity-20 hover:bg-opacity-30 px-6 py-3 rounded-xl font-semibold transition flex items-center">
                    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
