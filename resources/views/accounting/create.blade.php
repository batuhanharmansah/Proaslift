...
@section('title', 'Yeni Muhasebe Kaydı - Harmanşah Yazılım')
    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="mb-8">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900">Yeni Muhasebe Kaydı</h1>
                    <p class="text-gray-600 mt-1">Gelir veya gider kaydı ekleyin</p>
                </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100">
            <form action="{{ route('accounting.store') }}" method="POST" class="p-6 space-y-6">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <select id="type" name="type" required
                            ...
                            <option value="maas" {{ old('type') === 'maas' ? 'selected' : '' }}>👥 Maaş</option>
                            <option value="vergi" {{ old('type') === 'vergi' ? 'selected' : '' }}>🏛️ Vergi</option>
                            <option value="sigorta" {{ old('type') === 'sigorta' ? 'selected' : '' }}>🛡️ Sigorta</option>
                        </select>
                        @error('type')
                ...
                <div>
                    ...
                    <textarea id="description" name="description" rows="3" required
                              ...
                              class="w-full px-4 py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent">{{ old('description') }}</textarea>
                    @error('description')
                        <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div>
                        ...
                        <select id="vat_rate" name="vat_rate"
                                class="w-full px-4 py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent">
                            <option value="0" {{ old('vat_rate') == '0' ? 'selected' : '' }}>0% (KDV Yok)</option>
                            ...
                            <option value="20" {{ old('vat_rate') == '20' || old('vat_rate') == '' ? 'selected' : '' }}>20% (Varsayılan)</option>
                        </select>
                        @error('vat_rate')
                            <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                        @enderror
                ...
                <div>
                    ...
                    <textarea id="notes" name="notes" rows="3"
                              ...
                              class="w-full px-4 py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent">{{ old('notes') }}</textarea>
                    @error('notes')
                        <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
